class Installation:
    ...
    def __init__(self, identifier, name, opening_hour, closing_hour, order_size, distances):
        """
        ...
        :param order_size: Standard order size of the installation. Will vary in different scenarios.
